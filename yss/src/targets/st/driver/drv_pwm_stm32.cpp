...
error Pwm::initialize(uint32_t psc, uint32_t arr, bool risingAtMatch)
{
	mDev->PSC = psc;
	mDev->ARR = arr;
...
error PwmCh2::initializeChannel(bool risingAtMatch)
{
#if defined(TIM_BDTR_MOE_Pos)
	setBitData(mDev->BDTR, true, TIM_BDTR_MOE_Pos);						// Primary Output Enable
#endif
...
error PwmCh3::initializeChannel(bool risingAtMatch)
{
#if defined(TIM_BDTR_MOE_Pos)
	setBitData(mDev->BDTR, true, TIM_BDTR_MOE_Pos);						// Primary Output Enable
#endif
...
error PwmCh4::initializeChannel(bool risingAtMatch)
{
#if defined(TIM_BDTR_MOE_Pos)
	setBitData(mDev->BDTR, true, TIM_BDTR_MOE_Pos);						// Primary Output Enable
#endif
